...
export function PortionBottomNav() {
  ...
  const updatePillPosition = useCallback(() => {
    ...
    const left =
      tabRect.left - barRect.left + (tabRect.width - SELECTED_CIRCLE_SIZE) / 2;
    setPillStyle({ left });
  }, [activeIndex]);
      ...
      >
        ...
        >
          <NavAction
            ...
            isActive={
              pathname === leftTabs[0].href ||
              pathname.startsWith(`${leftTabs[0].href}/`)
            }
          />
        </Box>
        <Box
        ...
        >
          <NavAction
            ...
            isActive={
              pathname === leftTabs[1].href ||
              pathname.startsWith(`${leftTabs[1].href}/`)
            }
          />
        </Box>
        ...
        >
          <NavAction
            ...
            isActive={
              pathname === rightTabs[0].href ||
              pathname.startsWith(`${rightTabs[0].href}/`)
            }
          />
        </Box>
        <Box
        ...
        >
          <NavAction
            ...
            isActive={
              pathname === rightTabs[1].href ||
              pathname.startsWith(`${rightTabs[1].href}/`)
            }
          />
        </Box>
      </Box>
